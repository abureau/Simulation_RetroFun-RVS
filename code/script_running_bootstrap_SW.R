...
pvalues = readRDS("pvalues_null_SW.RDS")
Z = read.table("Annot_Z_SW.mat")

log.pvalues = -log10(sapply(1:10000, function(x) {
	if(length(pvalues[[x]])==1) pvalues[[x]]
	else pvalues[[x]]$ACAT
	})
)
...
saveRDS(l,"/home/loicm/scratch/bootstrap_inflated_signal_SW.RDS")
...
saveRDS(l,"/home/loicm/scratch/bootstrap_highly_inflated_signal_SW.RDS")
