...
cat("Import CRH file\n")
#GRange elements in bed format
GRange_CRHs = import(args[2], format="bed")
...
n_variants_in_CRHs = length(overlaps_variants_CRHs[overlaps_variants_CRHs==1])
...
variants_tmp = cbind("TAD", variants_tmp)

variants_scenario100 = variants_tmp[,c(1,2,3,4,5,6,8)] 
variants_scenario75 = variants_tmp[,c(1,2,3,4,5,6,9)]
variants_scenario50 = variants_tmp[,c(1,2,3,4,5,6,10)]
