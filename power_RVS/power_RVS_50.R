...
p50.02.list = pall50.02.list = jf50.02.list = pall_lf50.02.list = list()

for (r in 1:length(ped_files_alter_50.02))
#for (r in 1:200)
  {
  cat("r=",r,"\n")
  pedfile = ped_files_alter_50.02[r]
...
p50.02.list[[r]] = p.vec
pall50.02.list[[r]] = pall.vec
pall_lf50.02.list[[r]] = pall_lf.vec
jf50.02.list[[r]] = jf
#min(pall_lf.vec)*length(pall_lf.vec)  
}

#save(p50.02.list,pall50.02.list,pall_lf50.02.list,jf50.02.list,file="alter50.02_v2.RData")
