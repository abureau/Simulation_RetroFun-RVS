...
p75.02.list = pall75.02.list = jf75.02.list = pall_lf75.02.list = list()

for (r in 1:length(ped_files_alter_75.02))
#for (r in 1:200)
  {
  cat("r=",r,"\n")
  pedfile = ped_files_alter_75.02[r]
...
p75.02.list[[r]] = p.vec
pall75.02.list[[r]] = pall.vec
pall_lf75.02.list[[r]] = pall_lf.vec
jf75.02.list[[r]] = jf
#min(pall_lf.vec)*length(pall_lf.vec)  
}

#save(p75.02.list,pall75.02.list,pall_lf75.02.list,jf75.02.list,file="alter75.02_v2.RData")
