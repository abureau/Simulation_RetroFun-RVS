...
p75.OR5.02.list = pall75.OR5.02.list = jf75.OR5.02.list = pall_lf75.OR5.02.list = list()

for (r in 1:length(ped_files_OR5_75.02))
#for (r in 1:200)
  {
  cat("r=",r,"\n")
  pedfile = ped_files_OR5_75.02[r]
...
p75.OR5.02.list[[r]] = p.vec
pall75.OR5.02.list[[r]] = pall.vec
pall_lf75.OR5.02.list[[r]] = pall_lf.vec
jf75.OR5.02.list[[r]] = jf
#min(pall_lf.vec)*length(pall_lf.vec)  
}

#save(p75.OR5.02.list,pall75.OR5.02.list,pall_lf75.OR5.02.list,jf75.OR5.02.list,file="OR5_75.02_v2.RData")
