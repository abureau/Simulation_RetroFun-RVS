...
p100.OR5.01.list = pall100.OR5.01.list = jf100.OR5.01.list = pall_lf100.OR5.01.list = list()

for (r in 1:length(ped_files_OR5_100.01))
#for (r in 1:200)
  {
  cat("r=",r,"\n")
  pedfile = ped_files_OR5_100.01[r]
...
p100.OR5.01.list[[r]] = p.vec
pall100.OR5.01.list[[r]] = pall.vec
pall_lf100.OR5.01.list[[r]] = pall_lf.vec
jf100.OR5.01.list[[r]] = jf
#min(pall_lf.vec)*length(pall_lf.vec)  
}

#save(p100.OR5.01.list,pall100.OR5.01.list,pall_lf100.OR5.01.list,jf100.OR5.01.list,file="OR5_100.01_v2.RData")
